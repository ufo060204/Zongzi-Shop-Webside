  ...
  <div class="d-flex flex-column vh-100">
    <header :class="{ 'bg-white': mobileHeadBg }" class="fixed-top transition">
      <div class="container-md">
        <div class="d-md-flex justify-content-between align-items-center">
          <h2 class="mb-0 d-flex justify-content-between align-items-center py-3 py-md-5">
            ...
            <div class="nav-display align-items-center">
          ...
          <nav class="d-none d-md-block">
            <ul class="d-md-flex text-center list-unstyled m-0 py-11 py-md-0">
              <li>
      ...
      <nav ref="navCollapse" class="collapse bg-bg" id="collapseMenu">
        <ul class="d-md-flex text-center list-unstyled m-0 py-11 py-md-0">
          <li>
            <router-link to="/about" class="d-block text-decoration-none fw-bold me-md-6 py-2 nav-text-white">品牌故事</router-link>
          </li>
          <li>
            <router-link to="/products" class="d-block text-decoration-none fw-bold me-md-6 py-2 nav-text-white">美味專區</router-link>
          </li>
        </ul>
      </nav>
    </header>
        ...
        <div class="d-md-flex justify-content-md-between py-7">
          <div>
            ...
            <div class="d-md-flex d-none align-items-md-center">
              <router-link to="/login" style="background-color: #FFFFFF33;font-size: 12px;" class="footer-link p-2 me-2 fw-bold transition">後台管理</router-link>
              <p style="color: #FFFFFF80;font-size: 14px;" class="m-0">此專題僅供作品展示，非商業用途使用</p>
            </div>
          </div>
          <div class="d-md-flex mb-md-0 mb-6">
            <div class="ps-md-6 d-md-flex flex-md-column justify-content-md-between footer-border" style="padding-right: 40px;">
              ...
              <p class="m-md-0 mb-4">
                <a class="footer-link fs-5 transition" href="tel:0988-789456">0988-789456</a>
              </p>
            </div>
            <div class="ps-md-6 d-md-flex flex-md-column justify-content-md-between footer-border">
              <h5 class="mb-md-0 mb-3 fw-bold text-primary">電子信箱</h5>
              <p class="mb-md-0 mb-4">
                <a class="footer-link fs-5 transition" href="mailto:zongzi0624@gmail.com">zongzi0624@gmail.com</a>
              </p>
              ...
              <ul style="max-width: 128px;" class="mb-0 d-flex justify-content-between list-unstyled">
                <li><a style="font-size: 23px;" class="footer-link d-block transition" target="_blank" href="https://www.facebook.com/"><font-awesome-icon icon="fa-brands fa-facebook" /></a></li>
                <li><a style="font-size: 23px;" class="footer-link transition" target="_blank" href="https://www.instagram.com/"><font-awesome-icon icon="fa-brands fa-instagram" /></a></li>
                <li><a style="font-size: 23px;" class="footer-link transition" target="_blank" href="https://twitter.com/"><font-awesome-icon icon="fa-brands fa-twitter" /></a></li>
              </ul>
            </div>
          </div>
