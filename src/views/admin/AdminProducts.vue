<template>
  ...
  <div class="container">
    <div class="text-end mt-4">
      <button class="btn btn-primary" @click="$event =>openModal('create')">
        建立新的產品
      </button>
    </div>
          ...
          <td>
            <div class="btn-group">
              <button
                ...
                @click="$event =>openModal('edit',product)"
              >
                編輯
              </button>
              <button type="button" class="btn btn-outline-danger btn-sm" @click="$event =>openModal('delete',product)">
                刪除
              </button>
            </div>
          </td>
    ...
    <BackPagination :pages="page" :get-products="getProducts"></BackPagination>
  </div>
  <!-- Modal -->
  <!-- <div
    id="productModal"
  ...
  <!-- <div
    ...
    aria-hidden="true"
  >
    <product-modal :temp-product="tempProduct" :update-product="updateProduct" :delete-product="deleteProduct"></product-modal>
  </div> -->
  <!-- Modal -->

  <!-- delModal -->
  <!-- <div class="modal-dialog" id="delProductModal" ref="delProductModal">
    <div class="modal-content border-0">
